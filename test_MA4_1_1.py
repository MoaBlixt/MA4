...
from MA4_1_1 import approximate_pi
...
class Test(unittest.TestCase):
    ...
    def test_approximate_pi(self):
        ...
        pi_a,c_inside, c_outside  = approximate_pi(1000)
